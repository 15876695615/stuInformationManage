...
public class UsersService {
    ...
    public boolean addUsers(Users users){
        String hql = "from Users u where u.uname='"+users.getU_name()+"'";
        List<Users> uList = usersDao.findUsersList(hql);
        for (Users u : uList){
            if(u.getU_name().equals(users.getU_name()) && u.getU_pwd().equals(users.getU_pwd())){
                return false;
            }
        }
