...
<body>
    ...
    <form method="post" action="studentAction/addStudent">
        学生姓名：<input name="s_name" placeholder="请输入姓名">  <br/>
        ...
        年&nbsp;&nbsp;龄：<input name="s_age" placeholder="请输入年龄"><br/>
        邮&nbsp;&nbsp;箱：<input name="s_mail" placeholder="请填写邮箱"><br/>
        电&nbsp;&nbsp;话：<input name="s_tel" placeholder="请输入电话"><br/>
