...
<div id="main">
    ...
    <div class="form">
        ...
        <form method="post" action="${pageContext.request.contextPath}/usersAction/loginUsers" onsubmit="return checkout()">
            ...
            <input class="myButton" type="submit" value="登&nbsp;&nbsp;录"><br/>
            <input class="myButton2" type="submit" value="注&nbsp;&nbsp;册">
        </form>
    </div>
